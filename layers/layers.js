...
var format_pais_1 = new ol.format.GeoJSON();
var features_pais_1 = format_pais_1.readFeatures(json_pais_1,
    {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_pais_1 = new ol.source.Vector({
  attributions: '<a href=""></a>',
});
jsonSource_pais_1.addFeatures(features_pais_1);
var lyr_pais_1 = new ol.layer.Vector({
  declutter: true,
  source:jsonSource_pais_1,
  style: style_pais_1,
  title: '<img src="styles/legend/pais_1.png" /> pais'
});
...
var layersList = [group_group1,group_Path,lyr_pais_1,layer_radar,layer_cloud,layer_Satellite];

lyr_pais_1.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'pais': 'pais', 'pais_c': 'pais_c', });
lyr_pais_1.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'pais': 'TextEdit', 'pais_c': 'TextEdit', });
lyr_pais_1.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'pais': 'no label', 'pais_c': 'no label', });
